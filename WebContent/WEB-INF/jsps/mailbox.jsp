...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.4/mailbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Mar 2016 21:41:41 GMT -->
<head>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        <li class="active"><a href="resources/mailbox.html">Inbox</a></li>
        ...
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom" action="http://webapplayers.com/inspinia_admin-v2.4/search_results.html">
                <div class="form-group">
                    <input type="text" placeholder="Search for somethingresources." class="form-control" name="top-search" id="top-search">
                </div>
            </form>
        </div>
        ...
        <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content mailbox-content">
                        <div class="file-manager">
                            <a class="btn btn-block btn-primary compose-mail" href="resources/mail_compose.html">Compose Mail</a>
                            <div class="space-25"></div>
                            <h5>Folders</h5>
                            <ul class="folder-list m-b-md" style="padding: 0">
                                <li><a href="resources/mailbox.html"> <i class="fa fa-inbox "></i> Inbox <span class="label label-warning pull-right">16</span> </a></li>
                                <li><a href="resources/mailbox.html"> <i class="fa fa-envelope-o"></i> Send Mail</a></li>
                                <li><a href="resources/mailbox.html"> <i class="fa fa-certificate"></i> Important</a></li>
                                <li><a href="resources/mailbox.html"> <i class="fa fa-file-text-o"></i> Drafts <span class="label label-danger pull-right">2</span></a></li>
                                <li><a href="resources/mailbox.html"> <i class="fa fa-trash-o"></i> Trash</a></li>
                            </ul>
                            <h5>Categories</h5>
                            <ul class="category-list" style="padding: 0">
                                <li><a href="resources/#"> <i class="fa fa-circle text-navy"></i> Work </a></li>
                                <li><a href="resources/#"> <i class="fa fa-circle text-danger"></i> Documents</a></li>
                                <li><a href="resources/#"> <i class="fa fa-circle text-primary"></i> Social</a></li>
                                <li><a href="resources/#"> <i class="fa fa-circle text-info"></i> Advertising</a></li>
                                <li><a href="resources/#"> <i class="fa fa-circle text-warning"></i> Clients</a></li>
                            </ul>

                            <h5 class="tag-title">Labels</h5>
                            <ul class="tag-list" style="padding: 0">
                                <li><a href="resources/#"><i class="fa fa-tag"></i> Family</a></li>
                                <li><a href="resources/#"><i class="fa fa-tag"></i> Work</a></li>
                                <li><a href="resources/#"><i class="fa fa-tag"></i> Home</a></li>
                                <li><a href="resources/#"><i class="fa fa-tag"></i> Children</a></li>
                                <li><a href="resources/#"><i class="fa fa-tag"></i> Holidays</a></li>
                                <li><a href="resources/#"><i class="fa fa-tag"></i> Music</a></li>
                                <li><a href="resources/#"><i class="fa fa-tag"></i> Photography</a></li>
                                <li><a href="resources/#"><i class="fa fa-tag"></i> Film</a></li>
                            </ul>
            ...
            <div class="mail-box-header">
                ...
                <form method="get" action="http://webapplayers.com/inspinia_admin-v2.4/index.html" class="pull-right mail-search">
                ...
                <tr class="unread">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Anna Smith</a></td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">Lorem ipsum dolor noretek imit set.</a></td>
                ...
                <tr class="unread">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Jack Nowak</a></td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">Aldus PageMaker including versions of Lorem Ipsum.</a></td>
                    <td class=""></td>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Facebook</a> <span class="label label-warning pull-right">Clients</span> </td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">Many desktop publishing packages and web page editors.</a></td>
                    <td class=""></td>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Mailchip</a></td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">There are many variations of passages of Lorem Ipsum.</a></td>
                    <td class=""></td>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Alex T.</a> <span class="label label-danger pull-right">Documents</span></td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">Lorem ipsum dolor noretek imit set.</a></td>
                    <td class=""><i class="fa fa-paperclip"></i></td>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Monica Ryther</a></td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">The standard chunk of Lorem Ipsum used.</a></td>
                    <td class=""></td>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Sandra Derick</a></td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">Contrary to popular belief.</a></td>
                    <td class=""></td>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Patrick Pertners</a> <span class="label label-info pull-right">Adv</span></td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">If you are going to use a passage of Lorem </a></td>
                    <td class=""></td>
                    <td class="text-right mail-date">May 28</td>
                </tr>
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Michael Fox</a></td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">Humour, or non-characteristic words etc.</a></td>
                    <td class=""></td>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Damien Ritz</a></td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">Oor Lorem Ipsum is that it has a more-or-less normal.</a></td>
                    <td class=""></td>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Alex T.</a> <span class="label label-warning pull-right">Clients</span></td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">Lorem ipsum dolor noretek imit set.</a></td>
                    <td class=""><i class="fa fa-paperclip"></i></td>
                    <td class="text-right mail-date">December 22</td>
                </tr>
                ...
                <tr class="read">
                    ...
                    <td class="mail-ontact"><a href="resources/mail_detail.html">Patrick Pertners</a> </td>
                    <td class="mail-subject"><a href="resources/mail_detail.html">If you are going to use a passage of Lorem </a></td>
                    <td class=""></td>
                    <td class="text-right mail-date">May 28</td>
                </tr>
...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.4/mailbox.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 24 Mar 2016 21:41:44 GMT -->
</html>
