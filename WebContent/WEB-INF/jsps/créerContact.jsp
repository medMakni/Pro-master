	...
	<div id="wrapper">
		...
		<div class="sidebar-collapse">
			<ul class="nav metismenu" id="side-menu">
				...
				<li><a href="resources/index-2.html"><i
					...
					<ul class="nav nav-second-level collapse">
						...
						<li><a href="resources/dashboard_5.html">Dashboard v.5 <span
								class="label label-primary pull-right">NEW</span></a></li>
					</ul></li>
				<li><a href="resources/layouts.html"><i
						class="fa fa-diamond"></i> <span class="nav-label">Layouts</span></a>
				</li>
				<li><a href="resources/#"><i class="fa fa-bar-chart-o"></i>
						<span class="nav-label">Graphs</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level collapse">
						<li><a href="resources/graph_flot.html">Flot Charts</a></li>
						<li><a href="resources/graph_morris.html">Morris.js
								Charts</a></li>
						<li><a href="resources/graph_rickshaw.html">Rickshaw
								Charts</a></li>
						...
						<li><a href="resources/graph_sparkline.html">Sparkline
								Charts</a></li>
					</ul></li>
				<li><a href="resources/mailbox.html"><i
					...
					<ul class="nav nav-second-level collapse">
						...
						<li><a href="resources/email_template.html">Email
								templates</a></li>
					</ul></li>
				<li><a href="resources/metrics.html"><i
						class="fa fa-pie-chart"></i> <span class="nav-label">Metrics</span>
				</a></li>
				<li><a href="resources/widgets.html"><i class="fa fa-flask"></i>
						<span class="nav-label">Widgets</span></a></li>
				<li class="active"><a href="resources/#"><i
						class="fa fa-edit"></i> <span class="nav-label">Forms</span><span
						class="fa arrow"></span></a>
					<ul class="nav nav-second-level">
						<li class="active"><a href="resources/form_basic.html">Basic
								form</a></li>
						<li><a href="resources/form_advanced.html">Advanced
								Plugins</a></li>
				...
				<li><a href="resources/#"><i class="fa fa-desktop"></i> <span
					...
					<ul class="nav nav-second-level collapse">
						...
						<li><a href="resources/project_detail.html">Project
								detail</a></li>
				...
				<li><a href="resources/#"><i class="fa fa-files-o"></i> <span
						class="nav-label">Other Pages</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level collapse">
						<li><a href="resources/search_results.html">Search
								results</a></li>
						...
						<li><a href="resources/forgot_password.html">Forget
								password</a></li>
				...
				<li><a href="resources/#"><i class="fa fa-globe"></i> <span
					...
					<ul class="nav nav-second-level collapse">
						...
						<li><a href="resources/loading_buttons.html">Loading
								buttons</a></li>
				...
				<li><a href="resources/#"><i class="fa fa-flask"></i> <span
					...
					<ul class="nav nav-second-level collapse">
						...
						<li><a href="resources/draggable_panels.html">Draggable
								Panels</a></li>
						<li><a href="resources/resizeable_panels.html">Resizeable
								Panels</a></li>
						...
						<li><a href="resources/notifications.html">Notifications
								& Tooltips</a></li>
						<li><a href="resources/badges_labels.html">Badges,
								Labels, Progress</a></li>
					</ul></li>

				<li><a href="resources/grid_options.html"><i
						class="fa fa-laptop"></i> <span class="nav-label">Grid
							options</span></a></li>
				<li><a href="resources/#"><i class="fa fa-table"></i> <span
						class="nav-label">Tables</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level collapse">
						<li><a href="resources/table_basic.html">Static Tables</a></li>
						<li><a href="resources/table_data_tables.html">Data
								Tables</a></li>
						<li><a href="resources/table_foo_table.html">Foo Tables</a></li>
						<li><a href="resources/jq_grid.html">jqGrid</a></li>
					</ul></li>
				<li><a href="resources/#"><i class="fa fa-shopping-cart"></i>
						<span class="nav-label">E-commerce</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level collapse">
						<li><a href="resources/ecommerce_products_grid.html">Products
								grid</a></li>
						<li><a href="resources/ecommerce_product_list.html">Products
								list</a></li>
						<li><a href="resources/ecommerce_product.html">Product
								edit</a></li>
						<li><a href="resources/ecommerce_product_detail.html">Product
								detail</a></li>
						<li><a href="resources/ecommerce-cart.html">Cart</a></li>
						<li><a href="resources/ecommerce-orders.html">Orders</a></li>
						<li><a href="resources/ecommerce_payments.html">Credit
								Card form</a></li>
					</ul></li>
				<li><a href="resources/#"><i class="fa fa-picture-o"></i> <span
						class="nav-label">Gallery</span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level collapse">
						<li><a href="resources/basic_gallery.html">Lightbox
								Gallery</a></li>
						<li><a href="resources/slick_carousel.html">Slick
								Carousel</a></li>
						<li><a href="resources/carousel.html">Bootstrap Carousel</a></li>

					</ul></li>
				<li><a href="resources/#"><i class="fa fa-sitemap"></i> <span
						class="nav-label">Menu Levels </span><span class="fa arrow"></span></a>
					<ul class="nav nav-second-level collapse">
						<li><a href="resources/#">Third Level <span
								class="fa arrow"></span></a>
							<ul class="nav nav-third-level">
								<li><a href="resources/#">Third Level Item</a></li>
								<li><a href="resources/#">Third Level Item</a></li>
								<li><a href="resources/#">Third Level Item</a></li>
				...
				<li><a href="resources/css_animation.html"><i
						class="fa fa-magic"></i> <span class="nav-label">CSS
							Animations </span><span class="label label-info pull-right">62</span></a></li>
				<li class="landing_link"><a target="_blank"
					href="resources/landing.html"><i class="fa fa-star"></i> <span
						class="nav-label">Landing Page</span> <span
						class="label label-warning pull-right">NEW</span></a></li>
				<li class="special_link"><a href="resources/package.html"><i
					...
					<li class="dropdown"><a class="dropdown-toggle count-info"
						...
						<ul class="dropdown-menu dropdown-messages">
							...
							<li>
								<div class="dropdown-messages-box">
									<a href="resources/profile.html" class="pull-left"> <img
										alt="image" class="img-circle" src="resources/img/profile.jpg">
									</a>
									<div class="media-body ">
							...
							<li>
								<div class="text-center link-block">
									<a href="resources/mailbox.html"> <i class="fa fa-envelope"></i>
					...
					<div class="col-lg-12">
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<h5>
									All form elements <small>With custom checkbox and
										radion elements.</small>
								</h5>
