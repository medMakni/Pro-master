                ...
                <div class="mail-body">
                    ...
                    <form class="form-horizontal" method="get">
						...
						<div class="form-group"><label class="col-sm-2 control-label">Catégorie:</label>
							...
							<div class="btn-group">
								<button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">Courrier Normal<span class="caret"></span></button>
						...
						<br>
						<div class="form-group">
						<label class="col-sm-2 control-label">Date.Courrier:</label>

						<div class="col-sm-4">
								<input  maxlength="100" type="date" class="form-control" placeholder="Enter the Date"  required name="BirthDate" />
						</div>
						<label class="col-sm-2 control-label">Date arrivée:</label>
