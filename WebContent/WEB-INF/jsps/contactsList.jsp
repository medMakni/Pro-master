            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="resources/empty_page.html">Empty page</a></li>
                    </ul>
                </li>
                <li>
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="resources/index-2.html">This is</a>
                    </li>
                    <li class="active">
            ...
            <div class="col-sm-8">
                <div class="title-action">
                    <a href="resources/#" class="btn btn-primary">This is action area</a>
                </div>
            </div>
        </div>
