        ...
        <div class="row border-bottom">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="get">
                            <p><span class="label label-info">Courrier</span></p>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="btn-group" data-toggle="buttons">
                                        <label class="btn btn-primary active">
                                            <input type="radio" name="options" id="lettre" autocomplete="off" checked> Lettre
                                        </label>
                                        <label class="btn btn-primary">
                                            <input type="radio" name="options" id="mail" autocomplete="off"> Mail
                                        </label>
                                        <label class="btn btn-primary">
                                            <input type="radio" name="options" id="fax" autocomplete="off"> Fax
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="btn-group">
                                    <button data-toggle="dropdown" class="btn btn-default dropdown-toggle">Courrier Normal<span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                        <li><a href="#" class="font-bold">Courrier Normal</a></li>
                                        <li><a href="#" class="font-bold">Courrier à la clientèle</a></li>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label class="control-label col-sm-5" for="date_added">Date Courrier</label>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label class="control-label col-sm-7" for="date_modified">Date Arrivée</label>
                                        <div class="input-group date">
                            ...
                            <p><span class="label label-info">Origine</span></p>
                            <br>
                            <div class="form-group">
                            ...
                            <br>
                            <p><span class="label label-info">Corps</span></p>
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" method="get">
                            <p><span class="label label-info">Intervenants</span></p>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Responsable:</label>
                                <div class="col-sm-10">
                                    <div data-toggle="buttons-checkbox" class="btn-group" >
                                        <button class="btn btn-primary btn-outline" type="button"> Lettre</button>
                                        <button class="btn btn-primary btn-outline" type="button"> Mail</button>
                                        <button class="btn btn-primary btn-outline" type="button"> Fax</button>
                                    </div>
                                </div>
                            </div>
                            <br>
                            ...
                            <p><span class="label label-info">Workflow</span></p>
                            <div class="form-group">
                            ...
                            <button class="btn btn-warning " type="button"><i class="fa fa-warning"></i> <span class="bold">annuler</span></button>
